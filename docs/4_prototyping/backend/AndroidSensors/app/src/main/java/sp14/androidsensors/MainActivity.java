...
//        Log.d(TAG, "onCreate: Registered accelerometer listener");
    ...
    public void onLocationChanged(Location location) {
        ...
        Log.i(TAG, "Sensors & GPS - Longitude: " + longitude + " Latitude :" + latitude);
    }
    ...
    public void onSensorChanged(SensorEvent event) {
        ...
        if(sensor.getType() == Sensor.TYPE_ACCELEROMETER){
            Log.i(TAG, "Sensors & GPS - Accelerometer: X: " + event.values[0] + " Y:" + event.values[1] + " Z: " + event.values[2]);
            xAccel.setText("X: " + event.values[0]);
            yAccel.setText("Y: " + event.values[1]);
            zAccel.setText("Z: " + event.values[2]);
        }
        else if (sensor.getType() == Sensor.TYPE_GYROSCOPE) {
            Log.i(TAG, "Sensors & GPS - Gyroscope: X: " + event.values[0] + " Y:" + event.values[1] + " Z: " + event.values[2]);
            xGyro.setText("X: " + event.values[0]);
            yGyro.setText("Y: " + event.values[1]);
            zGyro.setText("Z: " + event.values[2]);
        }
        else if (sensor.getType() == Sensor.TYPE_MAGNETIC_FIELD) {
            Log.i(TAG, "Sensors & GPS - Magnetometer: X: " + event.values[0] + " Y:" + event.values[1] + " Z: " + event.values[2]);
