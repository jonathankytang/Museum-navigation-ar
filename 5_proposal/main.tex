...
\input{chapters/1_userNeedOverview.tex}

\chapter{Data Gathering and Requirements}
\input{chapters/2_dataGathering.tex}

\chapter{Functional Specification}
\input{chapters/3_functionalSpecification.tex}

\chapter{Ethical Audit}
\input{chapters/4_ethicalAudit.tex}

\chapter{Design}
\input{chapters/5_design.tex}

\chapter{Prototyping}
\input{chapters/6_prototyping.tex}

\chapter{Technical Architecture}
\input{chapters/7_technicalArchitecture.tex}

\chapter{Evaluation Plan}
\input{chapters/8_evaluationPlan.tex}

\chapter{Project Management}
\input{chapters/9_projectManagement.tex}
