...
The functional requirements are the most critical then FR because even if we missed one or two FR, the system will work properly whereas if we missed any NFR their will be problem where system can became useless. This is why we have focus more on NFR.
\begin{enumerate}
