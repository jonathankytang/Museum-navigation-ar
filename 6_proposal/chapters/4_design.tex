...
% Having a design process allows for greater efficiency, and transparency when designing the application. It overcomes the risk of referring back to the drawing board during implementation, setting in stone the main features, and functionality of the application.
